...
type ServiceEventCallback = (...args: any[]) => void;
type ServiceEventRecordArray = {
    [key: string]: {
        fun: (...args: any[]) => void,
        once: boolean
    }[]
...
export abstract class Service<EXPANSION_EVENTS extends string> implements EventEmitter {
